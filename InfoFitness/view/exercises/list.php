...
$newExercise = $view->getVariable("newExercise");
 ...
 <table>
     ...
     <?php foreach($exercises as $exercise): ?>
         <tr class="mainTable">
             <form action="?controller=exercises&action=modify" method="POST">
                 ...
                 <th> <input name="exerciseMedia" value="<?= $exercise->getMedia() ?>"> </th>
     ...
     <?php endforeach; ?>
     <tr>
         <form action="?controller=exercises&action=add" method="POST">
           ...
           <th> <input name="exerciseMedia" value="<?= $newExercise->getMedia() ?>"> </th>
